...
export const DEMAND_INFLUENCES = {
  ...
  arrivalVenue: definition(
    'arrival',
    'Venue',
    'VENUE_DEMAND_FACTOR[state.venueId]; cart 1 through department store 1.62.',
    1,
    'positive-only',
    'factor',
    1,
  ...
  arrivalTeamEquipment: definition(
    ...
    'operationalEffects(state).demandMultiplier from scheduled people-person traits and the installed POS tier.',
    1,
    'positive-only',
    'factor',
    1,

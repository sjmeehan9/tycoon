%%% output: .claude/agents/tech-lead.md
...
memory: project
---
%%% output: .github/agents/TechLead.agent.md
%%% flags: copilot interactive
---
name: TechLead
description: Senior Tech Lead agent that refines ONE phase of the approved phase plan into a technically validated component breakdown with file-level specs and acceptance criteria. Use when a phase needs component-level detail before implementation can begin.
argument-hint: Name the phase to refine (e.g. "Phase 2") — I will produce docs/phase-X-component-breakdown.md and create or update docs/phase-progress.json for that phase.
tools: ['read', 'search', 'edit', 'web', 'todo']
---
%%% output: .codex/agents/tech-lead.toml

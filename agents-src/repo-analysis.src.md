%%% output: .claude/agents/repo-analysis.md
...
memory: project
---
%%% output: .github/agents/RepoAnalysis.agent.md
%%% flags: copilot interactive
---
name: RepoAnalysis
description: Deep technical analysis of an existing repository — maps architecture, traces execution flows, rates code quality, and classifies every module for refactor/reuse. Use before planning a refactor, when inheriting an unfamiliar codebase, or when a project starts from an existing repository.
...
---
%%% output: .codex/agents/repo-analysis.toml

%%% output: .claude/agents/solutions-architect.md
%%% flags: claude interactive full teams
---
...
memory: project
---
%%% output: .github/agents/SolutionsArchitect.agent.md
%%% flags: copilot interactive full
---
name: SolutionsArchitect
description: Technical solution design agent — transforms the approved project brief into docs/solution-design.md, with architecture, technology stack, data model, security, and end-to-end testing scenarios shaped to the project's platform. Use when an approved brief needs a complete technical design, or when architectural decisions need to be made or revised.
argument-hint: Point me at the approved brief (docs/brief.md) and requirements (docs/requirements.md), and I will create docs/solution-design.md — the complete architectural blueprint the Technical Business Analyst plans from.
tools: ['read', 'search', 'edit', 'web', 'todo']
---
%%% output: .github/agents/SolutionsArchitectLite.agent.md
%%% flags: copilot interactive lite
---
name: SolutionsArchitectLite
description: Reduced-scope technical solution design agent — transforms the approved project brief into a trimmed docs/solution-design.md covering architecture, technology stack, data model, and testing scenarios shaped to the project's platform. Use for smaller projects where the full design template (failure-mode tables, capacity planning, disaster recovery) is more than the project shape warrants.
argument-hint: Point me at the approved brief (docs/brief.md) and requirements (docs/requirements.md), and I will create a reduced-scope docs/solution-design.md sized for a smaller project.
tools: ['read', 'search', 'edit', 'web', 'todo']
---
%%% output: .github/agents/SolutionsArchitectLiteAutonomous.agent.md
%%% flags: copilot autonomous lite
---
...
tools: ['read', 'search', 'edit', 'web', 'todo']
---
%%% output: .codex/agents/solutions-architect.toml
%%% flags: codex interactive full teams
name = "solutions-architect"
description = "Technical solution design agent — transforms the approved project brief into docs/solution-design.md, with architecture, technology stack, data model, security, and end-to-end testing scenarios shaped to the project's platform. Use when an approved brief needs a complete technical design, or when architectural decisions need to be made or revised."
%%% body
